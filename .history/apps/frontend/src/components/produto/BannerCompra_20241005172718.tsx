		...
		<div className="flex">
			<div className="flex flex-col border-r border-zinc-500 pr-5">
				...
				<div className="text-2xl font-semibold">
					<span className="text-base text-zinc-300">por</span> <span className="text-emerald-500"> {Moeda.formatar(produto?.precoPromocional)}</span> <span className="text-base text-zinc-300">à vista</span>
				</div>
			</div>
